    ...
    return (
        <Dialog open={true} onClose={onCancel} fullWidth maxWidth="md">
            <DialogTitle className="text-center bg-gray-50 relative text-gray-800 ">
                Add Task
                <IconButton onClick={onCancel} sx={{ position: "absolute", top: 8, right: 8, color: "gray" }}>
                    <CloseIcon />
                </IconButton>
            </DialogTitle>
                ...
                <form className="space-y-4 mt-3">
                    <TextField
                        ...
                        sx={{
                            ...
                            "& .MuiOutlinedInput-root": {
                                "& fieldset": { borderColor: "#BFDBFE", borderWidth: "0.25px", borderRadius: "15px" },
                                "&:hover fieldset": { borderColor: "#BFDBFE", borderWidth: "0.5px" },
                                "&.Mui-focused fieldset": { borderColor: "#BFDBFE", borderWidth: "0.25px" },
                            },
                        }}
                    />

                    <FormControl fullWidth sx={{ bgcolor: "gray.900", marginTop: "10px" }}>
                        <InputLabel id="task-assign-label" sx={{ color: "gray", "&.Mui-focused": { color: "gray" } }}>
                            User Task Assign
                        </InputLabel>
                        <Select
                            ...
                            sx={{
                                ...
                                "&.Mui-focused .MuiOutlinedInput-notchedOutline": { borderColor: "#BFDBFE" },
                    ...
                    <TextField
                        ...
                        sx={{
                            ...
                            "& .MuiOutlinedInput-root": {
                                "& fieldset": { borderColor: "#BFDBFE", borderWidth: "0.25px", borderRadius: "15px" },
                                "&:hover fieldset": { borderColor: "#BFDBFE", borderWidth: "0.25px" },
                                "&.Mui-focused fieldset": { borderColor: "#BFDBFE", borderWidth: "0.25px" },
                            },
                        }}
                    />
                    ...
                    <div className="flex items-center space-x-4">
                        ...
                        {["High", "Medium", "Low"].map((level) => (
                            <button
                                ...
                                className={`px-3 py-1 rounded-md ${formData.priority === level ? "bg-green-500 text-black font-bold" : "bg-gray-500 text-white"}`}
                            >
                    ...
                    {formData.repeat && (
                        <div>
                            <FormControl fullWidth sx={{ bgcolor: "gray.900", marginTop: "10px" }}>
                                <InputLabel id="repeat-type-label" sx={{ color: "gray", "&.Mui-focused": { color: "gray" } }}>
                                    Repeat Type
                                </InputLabel>
                                <Select
                    ...
                    >
                        <TextField
                            ...
                            sx={{
                                ...
                                label: { color: "gray" },
                                "& .MuiOutlinedInput-root": {
                                    "& fieldset": { borderColor: "#BFDBFE", borderWidth: "0.25px" },
                                    "&:hover fieldset": { borderColor: "#BFDBFE", borderWidth: "0.25px" },
                                    "&.Mui-focused fieldset": { borderColor: "#BFDBFE", borderWidth: "0.25px" },
                                },
                            }}
