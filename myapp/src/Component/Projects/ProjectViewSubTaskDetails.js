          ...
          <div className="md:col-span-2 space-y-6">
            <div className="bg-white rounded-lg py-3 shadow">
              <div className="flex flex-col items-start ml-5">
                ...
                <span className="text-gray-600 text-sm hover:cursor-default ">Current Status</span>
              </div>
            </div>
              ...
              <div className="w-full p-2">
                <div className='flex justify-between'>
                  ...
                  <label className="font-semibold text-gray-700 flex items-start ">
                    <button onClick={toggleOpen}><div className='flex flex-row text-sm items-center gap-2'>Description </div></button></label><button onClick={toggleOpen}><IoIosArrowForward className={`transition-transform duration-500 ${isopen ? "rotate-90" : "rotate-0"}`} /></button></div>
                {isopen &&
...
<div className="flex flex-row gap-1 mt-2">
  ...
  <button
    className="px-3 py-1 rounded-lg transition-colors duration-500 hover:bg-blue-600 hover:text-white"
  >
    Add
  </button>
</div>
            ...
            <div className="bg-white   p-3 rounded-lg ">
              ...
              <button onClick={toggleOpening} className="flex justify-between w-full items-center">
                ...
                <div className="grid grid-cols-2 gap-x-8 gap-y-4 bg-white p-6">
                  ...
                  <div className="space-y-4 ">
                    ...
                    <div className="flex border-b-[1px] border-gray-200 pb-2">
                      <span className="w-40 text-start text-gray-600">Priority:</span>
                      <span className={`text-sm font-medium ${getPriorityColor(subtaskData.priority)}`}>
                        {subtaskData.priority}
                      </span>
                    </div>
                    <div className="flex border-b-[1px] border-gray-200 pb-2">
                      <span className="w-40 text-start text-gray-600">Status:</span>
                    ...
                    <div className="flex border-b-[1px] border-gray-200 pb-2">
                      ...
                      <span className="font-medium">{subtaskData.cost || "None"}</span>
                    </div>
                    <div className="flex border-b-[1px] border-gray-200 pb-2">
                      <span className="w-40 text-start text-gray-600">Billing Type:</span>
                  ...
                  <div className="space-y-4">
                    <div className="flex border-b-[1px] border-gray-200 pb-2">
                      <span className="w-40 text-start text-gray-600">Start Date:</span>
                    ...
                    <div className="flex border-b-[1px] border-gray-200 pb-2">
                      <span className="w-40 text-start text-gray-600">Duration:</span>
                      <span className="font-medium">{subtaskData.duration}</span>
                    </div>
                    <div className="flex border-b-[1px] border-gray-200 pb-2">
                      <span className="w-40 text-start text-gray-600">Completion %:</span>
                      <span className="font-medium">{subtaskData.progress || 0}%</span>
                    </div>
                    <div className="flex border-b-[1px] border-gray-200 pb-2">
                      <span className="w-40 text-start text-gray-600">Work Hours:</span>
                      <span className="font-medium">00:00</span>
                    </div>
                    <div className="flex border-b-[1px] border-gray-200 pb-2">
                      <span className="w-40 text-start text-gray-600">Associated Team:</span>
