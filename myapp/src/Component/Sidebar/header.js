...
function Header() {
  return (
    <div className="flex justify-between items-center bg-gray-800 text-white p-4 fixed top-0 left-0 right-0 z-10 h-[30px] shadow-[0px_6px_10px_rgba(0,0,0,0.3),0px_10px_20px_rgba(0,0,0,0.4)]">
      {/* Left Side: Logo */}
